...
class CheckInfoBookingScreen extends StatefulWidget {
  final PropertyDetail property;

  const CheckInfoBookingScreen({
    super.key,
    required this.property,
  });

  @override
  _CheckInfoBookingScreenState createState() => _CheckInfoBookingScreenState();
}

class _CheckInfoBookingScreenState extends State<CheckInfoBookingScreen>
                            ...
                            Navigator.of(context).push(
                              PageRouteBuilder(
                                pageBuilder: (context, animation, secondaryAnimation) =>
                                    OrderDetailScreen(property: widget.property),
